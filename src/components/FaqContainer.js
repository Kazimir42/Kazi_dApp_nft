...
function FaqContainer() {
    return (
        <div className="small-container mx-auto pt-16 px-8 pb-32 gap-4">
            <h2 className="text-4xl lg:text-5xl font-black text-big-content-color text-center uppercase mb-16">FREQUENTLY ASKED <span className="text-primary">QUESTIONS</span></h2>
