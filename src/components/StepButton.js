...
function StepButton() {
    ...
    switch (currentStep)
    {
        ...
        case 'Sale':
            ...
            break
        case 'SoldOut':
            return <Link className="h-fit shadow-md rounded-sm mx-auto font-semibold block px-8 py-5 block bg-primary hover:bg-dark-primary transition duration-200 text-xl text-white w-fit text-center mb-1" to=''>View on OpenSea</Link>
            break
    }
}
